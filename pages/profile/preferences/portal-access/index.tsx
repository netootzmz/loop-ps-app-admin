...
const PortalAccess: PageWithStore = ({ dispatch, ui: { lang } }) => {
    ...
    dispatch(
      setPageTitle(
        titles.profile.preferences.title +
          ...
          " | " +
          titles.profile.preferences.portal_access.first_login
      )
    );
  }, [
    dispatch,
...
export default withAuth(wrappedOnStore(PortalAccess));
