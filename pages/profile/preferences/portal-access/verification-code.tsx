...
const VerificationCode: PageWithStore = ({ dispatch, ui: { lang } }) => {
    ...
    dispatch(
      setPageTitle(
        titles.profile.preferences.title +
          ...
          " | " +
          titles.profile.preferences.portal_access.verification_code
      )
    );
  }, [
    dispatch,
...
export default withAuth(wrappedOnStore(VerificationCode));
