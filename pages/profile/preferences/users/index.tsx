...
import UsersFilters from "../../../../components/profile/preferences/users/UsersFilters";
import UsersTable from "../../../../components/profile/preferences/users/UsersTable";
import { startGettingUsersTable } from "../../../../store/actions/preferencesActions";

const Users: PageWithStore = ({ dispatch, ui: { lang } }) => {
  ...
  useEffect(() => {
    ...
    dispatch(startGettingUsersTable({ stringToSearch: "" }, lang));
  }, [
    dispatch,
    titles.profile.preferences.title,
    titles.profile.preferences.users.title,
...
export default withAuth(wrappedOnStore(Users));
