...
>()
  ...
  .post(async (req, res) => {
    ...
    try {
      ...
      const apires = await customApiFetch<iMonetaryAdjustmentUpdateReq, iCustomResponse>(
        `${
            url || "http://192.168.18.90:8081"
        }/api/v1/smart/service-portal/monetary-adjustment/update-type`,
        req.body,
        token
      );
